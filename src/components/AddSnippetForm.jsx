...
import { LANGUAGES, APP_ID } from '../config/firebase-config';

export const AddSnippetForm = ({ db, userId, onSnippetAdded }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const collectionPath = `/artifacts/${APP_ID}/public/data/snippets`;
